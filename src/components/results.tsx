    ...
    <section className="py-24 bg-slate-50 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl md:text-5xl font-black text-slate-900 mb-6">Real Results, <span className="text-red-600">Real Proof</span></h2>
          <p className="text-slate-500 max-w-2xl mx-auto font-medium">Transparency is key. Here are some of the latest results generated by our community members using the CLT strategy.</p>
        </div>
        ...
        >
          <div className="inline-flex items-center gap-4 p-4 bg-white border border-slate-100 rounded-3xl shadow-xl shadow-slate-100">
            ...
            <p className="text-slate-600 text-sm font-bold">Over <span className="text-red-600">500+ screenshots</span> shared by students this week</p>
