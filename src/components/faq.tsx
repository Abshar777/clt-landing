...
const FAQItem: React.FC<{
  ...
  return (
    <motion.div
      ...
      className={`border-2 rounded-3xl mb-4 transition-all duration-300 ${
        isOpen ? "border-red-600 bg-red-50/30" : "border-slate-100 bg-white"
      }`}
    >
      <button
      ...
      <div className="max-w-4xl mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-slate-500 font-medium">
            Everything you need to know about starting your trading journey with
            CLT.
          </p>
        </div>
        ...
        >
          ...
          <p className="text-slate-500 mb-6">
            Our academic counselors are ready to help you 24/7.
          </p>
          <button
            data-click="whatsapp"
            onClick={whatsappRedirect}
            className=" whatsapp   text-red-600 font-black flex items-center gap-2 mx-auto hover:gap-4 transition-all"
          >
