    ...
    <>
      <div className="fixed bottom-8 left-1/2 transform -translate-x-1/2 z-50">
        <div className="flex items-center gap-2 p-1.5 bg-black/5 backdrop-blur-xl border border-black/5 shadow-[0_8px_30px_rgb(0,0,0,0.12)] rounded-full hover:scale-[1.02] transition-transform duration-300">
          <button
            onClick={() => setActiveVideo("/l.mp4")}
            className="flex items-center gap-2 px-5 py-3 rounded-full text-sm font-semibold text-slate-600 hover:bg-slate-100 transition-all group"
          >
          ...
          <button
            ...
            className=" whatsapp   shiny-cta focus:outline-none group"
          >
            <span>
              Let's Start
